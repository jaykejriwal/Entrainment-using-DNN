...
if __name__ == '__main__':
  ...
  dataset = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/semantic/train_nonorm.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_text_VACC_1randomBERT{fold}.pt'
