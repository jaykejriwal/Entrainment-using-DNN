...
if __name__ == '__main__':
  ...
  dataset_train_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Text/BERT/train_nonorm.h5')
  dataset_val_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Text/BERT/val_nonorm.h5')
  dataset_test_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Text/BERT/test_nonorm.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_text_USE_1randomCGCBERT{fold}.pt'
