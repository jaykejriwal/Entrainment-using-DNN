#Program uses L1 loss as cost function with L1 distance with one random variable
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  dataset_train_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Audio/lld/train_nonorm.h5')
  dataset_val_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Audio/lld/val_nonorm.h5')
  dataset_test_part = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Audio/lld/test_nonorm.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VACC_audio_checkLLD{fold}.pt'
