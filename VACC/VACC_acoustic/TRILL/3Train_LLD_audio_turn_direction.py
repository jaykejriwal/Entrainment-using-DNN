#Program to use smooth l1 loss as cost function and l1 distance with only one random variable
#Program trained on odd group i.e Alexa to Speaker
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  dataset = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/VACC/Audio/VACC_Turn_odd.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_VACCLLDsingleloss1odd{fold}.pt'
