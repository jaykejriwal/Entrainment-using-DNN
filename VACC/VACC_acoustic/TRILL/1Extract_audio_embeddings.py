...
output_path = '/home/jay_kejriwal/Fisher/Processed/Embeddings/VACC_audio'
audio_path = '/home/jay_kejriwal/Fisher/Processed/VACC_audio_resampled'
text_path= '/home/jay_kejriwal/Fisher/Processed/VACC_text'
        ...
        if file.endswith('.txt'):
            with open(os.path.join(root, file), 'r') as f:
                ...
                for line in text:
                    n1=line.split('\t')[0]
                    n2=line.split('\t')[1]
                    n3=os.path.join(audio_path, out_name).split('.txtturns_revised.txt')[0]+'.wav'
