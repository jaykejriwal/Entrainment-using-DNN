#Program to use smooth L1 loss as cost function and l1 distance with mean of 10 random variables
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_Fisher_text_BERT_new_10random{fold}.pt'
