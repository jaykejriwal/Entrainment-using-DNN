...
# Create h5 files
#Add path where embeddings are saved in csv file format
...
#Add path where training data needs to be saved
...
#Add path where validation data needs to be saved
...
#Add path where testing data needs to be saved
