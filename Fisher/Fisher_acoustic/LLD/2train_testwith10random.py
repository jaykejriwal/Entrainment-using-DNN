#Program uses Smooth L1 loss with L1 as distance measure with ten random variable
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  # Insert path of training, validation and testing h5 files
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_audio_LLD_10random{fold}.pt'
