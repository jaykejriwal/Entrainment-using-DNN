...
#Program uses entire turn as a unit of analysis
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  dataset = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/CGC/Audio/CGC_Turn.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_CGCLLDsingleloss1{fold}.pt'
