## The program reads each processed file and converts them into h5 format
#Three files are generated namely training, testing and validation
import csv
import h5py
import numpy as np
import pandas as pd
...
# Create h5 files
#Input path
sessListaudio= sorted(glob.glob('D:\Jay\columbia-games-corpus\jddataex_output\*.txt',recursive=True))
...
sessTrain = sessListaudio[:num_files_train]
sessVal = sessListaudio[num_files_train:num_files_val+num_files_train]
sessTest = sessListaudio[num_files_val+num_files_train:]
...
#Specify training output path
hf = h5py.File('/home/jay_kejriwal/Fisher/Processed/h5/CGC/Audio/train_nonorm.h5', 'w')
...
#Specify validation output path
hf = h5py.File('/home/jay_kejriwal/Fisher/Processed/h5/CGC/Audio/val_nonorm.h5', 'w')
...
#Specify testing output path
hf = h5py.File('/home/jay_kejriwal/Fisher/Processed/h5/CGC/Audio/test_nonorm.h5', 'w')
