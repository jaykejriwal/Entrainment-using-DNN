...
#Program uses L1 distance to measure distance between adjacent and non-adjacent embeddings with one random variable
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_CGC_TRILL_turn{fold}.pt'
