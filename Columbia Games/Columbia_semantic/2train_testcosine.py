...
#Program uses cosine distance for measuring distance
import os
import numpy as np
import torch
...
if __name__ == '__main__':
  ...
  dataset = EntDataset('/home/jay_kejriwal/Fisher/Processed/h5/CGC/semantic/train_nonorm.h5')
  ...
  for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    # Saving the model
    model_pth = f'/home/jay_kejriwal/Fisher/Processed/model/trained_VAE_text_CGC_cos1randomBERT{fold}.pt'
